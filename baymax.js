...
馃摦 : *Paket:* 10K 鈥? Sewabot 1 Minggu
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1bulan'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 20K 鈥? Sewabot 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 35K 鈥? Sewabot 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 45K 鈥? Sewabot Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'premkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 10K 鈥? Premium 1 Minggu
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1bulan'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 20K 鈥? Premium 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 35K 鈥? Premium 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 45K 鈥? Premium Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'botkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 10K 鈥? Jadibot 1 Minggu
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1bulan'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 20K 鈥? Jadibot 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 35K 鈥? Jadibot 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 45K 鈥? Jadibot Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'ownkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 10K 鈥? Jadi Owner 1 Minggu
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1bulan'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 20K 鈥? Jadi Owner 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 35K 鈥? Jadi Owner 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
baymax.sendMessage(creator,{text:`*鉂? ORDER 鉂?*
馃摦 : *Paket:* 45K 鈥? Jadi Owner Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'addprem':
